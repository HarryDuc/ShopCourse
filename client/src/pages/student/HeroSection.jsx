    ...
    <div className="relative bg-gradient-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-white text-4xl font-bold mb-4">
          Tìm khóa học tốt nhất cho bạn
        </h1>
        <p className="text-gray-200 dark:text-gray-400 mb-8">
          Khám phá, Học hỏi và Nâng cao kỹ năng với nhiều khóa học của chúng tôi
        </p>
       ...
       <Button onClick={()=> navigate(`/course/search?query`)} className="bg-white dark:bg-gray-800 text-blue-600 rounded-full hover:bg-gray-200">Khám phá các khóa học</Button>
      </div>
    </div>
  );
};
